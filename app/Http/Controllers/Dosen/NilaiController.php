...
class NilaiController extends Controller
{
    public function index()
    {
        ...
        $nilais = Nilai::where('mahasiswa_id', 1)->pluck('nilai')->avg();
        // dd($nilais);

        return view('frontend.nilais.index', compact('nilais'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.nilais.create', compact('mahasiswas', 'users'));
    }
    ...
    public function edit(Nilai $nilai)
    {
        ...
        return view('frontend.nilais.edit', compact('mahasiswas', 'nilai', 'users'));
    }
    ...
    public function update(UpdateNilaiRequest $request, Nilai $nilai)
    {
        ...
        return redirect()->route('frontend.nilais.index');
    }
    ...
    public function show(Nilai $nilai)
    {
        ...
        return view('frontend.nilais.show', compact('nilai'));
    }
