        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.orangtuas.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('nama_ibu') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama_ibu" id="nama_ibu" value="{{ old('nama_ibu', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('pekerjaan_ibu') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="pekerjaan_ibu" id="pekerjaan_ibu" required>
                                <option value disabled {{ old('pekerjaan_ibu', null) === null ? 'selected' : '' }}>Silahkan Pilih Salah Satu!</option>
                                @foreach(App\Models\Orangtua::PEKERJAAN_IBU_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('pekerjaan_ibu', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('nama_ayah') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama_ayah" id="nama_ayah" value="{{ old('nama_ayah', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('pekerjaan_ayah') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="pekerjaan_ayah" id="pekerjaan_ayah" required>
                                <option value disabled {{ old('pekerjaan_ayah', null) === null ? 'selected' : '' }}>Silahkan Pilih Salah Satu!</option>
                                @foreach(App\Models\Orangtua::PEKERJAAN_AYAH_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('pekerjaan_ayah', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
