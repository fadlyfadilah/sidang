        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" id="penguji-tab" data-toggle="tab" href="#penguji" role="tab"
                            aria-controls="penguji" aria-selected="false">Pilih Dosen Penguji</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="penguji" role="tabpanel" aria-labelledby="penguji-tab">

                        <form method="POST" action="{{ route('user.pengujis.store') }}" enctype="multipart/form-data">
                            @csrf
